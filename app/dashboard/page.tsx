          ...
          <div>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="border-2 border-base-300 p-5 flex justify-between items-center rounded-xl">
                <div className="flex flex-col">
                  ...
                  <span className='text-2xl font-bold text-accent'>
                    {totalCount !== null ? `${currentSymbol} ${totalAmount}` : 'N/A'}
                  </span>

                </div>

                <CircleDollarSign className="bg-accent w-9 h-9 text-white rounded-full p-1" />
              </div>
              ...
              <div className="border-2 border-base-300 p-5 flex justify-between items-center rounded-xl">
                ...
                <PiggyBank className="bg-accent w-9 h-9 text-white rounded-full p-1" />
              </div>

              <div className="border-2 border-base-300 p-5 flex justify-between items-center rounded-xl">
                <div className="flex flex-col">
                  <span className="text-gray-500 text-sm">Budgets Atteint</span>
                  <span className="text-2xl font-bold text-accent">
                    {reachedBudgetsRatio || "N/A"}
                  </span>
                </div>

                <Landmark className="bg-accent w-9 h-9 text-white rounded-full p-1" />
              </div>
            </div>
            ...
            <div className="w-full md:flex mt-4">
              ...
              <div className="md:w-1/3 ml-4">
                <h3 className="text-lg font-semibold mb-3">Derniers Budgets</h3>
         ...
         <div className="grid md:grid-cols-3 gap-4">
           <div className="border-2 border-base-300 p-5 flex justify-between items-center rounded-xl">
             <div className="flex flex-col">
               ...
               <span className="text-2xl font-bold text-accent">
                 {totalAmount !== null ? currentSymbol + " " + totalAmount : "N/A"}
               </span>
